...
public class EmailSender {
    ...
    private EmailSender() {
        // TODO: 2021/6/11 使用管理员发送邮箱账号
        EmailSender.config(EmailSender.SMTP_163(false), "", "");
    }
    ...
    public void send() {
        ...
        try {
            ...
            Transport.send(msg);
            // TODO: 2020/12/10  取消了发送email的log
//            log.info("email send..........");
        } catch (Exception e) {
    ...
    public static void sendInfo(String msg, String address) throws Exception {
        EmailSender.subject("服务器打卡信息")
                .from("磷氢碳自动打卡服务器")
                .text(msg)
                .to(address)
                .send();
